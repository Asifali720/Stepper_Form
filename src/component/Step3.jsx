...
const Step3 = () => {
  ...
  return (
    ...
    <input type="text" name="text" id="" value={userData['text'] || ''} onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600 mb-6' placeholder='Institude Name'/>
    ...
    <input type="date" name="date" id="" value={userData['date'] || ''} onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600' placeholder='date'/>
      </div>
      <div>
