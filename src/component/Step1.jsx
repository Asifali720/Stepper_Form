...
const Step1 = () => {
  ...
  return (
    <div className='px-10'>
      ...
      <input type="text" name="" id="" onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600 mb-6' placeholder='username' required/>
      ...
      <input type="email" name="" id="" onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600' placeholder='email' required/>
        </div>
        <div>
        <p className='text-base leading-6 text-black mb-2'>Resume</p>
      <input type="file" name="" id="" onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600' placeholder='email' required/>
        </div>
        <div>
        <p className='text-base leading-6 text-black mb-2'>Phone Number</p>
      <input type="tel" name="" id="" onChange={handleChange} className='w-full rounded-md p-4 placeholder:text-gray-400 text-green-600 outline-none focus:outline-green-600' placeholder='number' required/>
        </div>
      </div>
